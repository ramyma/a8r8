...
export const LoraButton = ({
  ...
  return (
    ...
    >
      <Button
        className={`pointer-events-auto absolute top-[-12px] left-[-12px] bg-neutral-800/70 border border-neutral-700 flex place-content-center ${active ? "opacity-100" : "opacity-0"}`}
        onClick={(e) => {
          e.stopPropagation();
          onClose(e);
        }}
