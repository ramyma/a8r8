...
const ScrollArea = ({ children, classNames = "" }: Props) => (
  <RadixScrollArea.Root className={"w-full h-full rounded " + classNames}>
    <RadixScrollArea.Viewport className="w-full h-full rounded [&>div]:!block">
      {children}
